...
<html>
    ...
    <body>
        <section class="content info-reservation">
            ...
            <div class="tab-menu1">
                <ul class="clearfix">
                    <li class="col-fourth on" id='tab-1'><a href="#none">항공권 안내</a></li>
                    <li class="col-fourth" id='tab-2'><a href="#none">온라인 예약</a></li>
                    ...
                    <div class="table-form2">
                        <div class="row clearfix">
                            ...
                            <div class="col-three-fourth">
                                <ul class="list-type2">
                                    <li><span class="font-brown">국제선 항공권 온라인예약은 조회일로부터 최대 361일까지 예약이 가능합니다.</span></li>
