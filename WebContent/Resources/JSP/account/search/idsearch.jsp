...
<html>
    ...
    <body>
        ...
        <section class="content">
            <h3>아이디 찾기</h3>
            <ul class="list-type2">
                <li>회원님의 개인정보 보호 및 정확한 회원정보 확인을 위하여 본인 인증 후 아이디를 안내해드리고 있습니다.</li>
            </ul>
            ...
            <div id="tab-1-container">
           		<form method="post" id="idFindFrm">
                    ...
                    <div class="row clearfix">
                        <input type="button" id="search" class="blueBtn confirm" value="확인">
                        <div id="result"></div>
                    </div>
                </form>
            </div>
                ...
                <div id="phone-verification-content1">
                    ...
                    <div class="carrier">
                        <div class="row clearfix">
                            ...
                            <label class="col-half logo-skt" for="skt" style="margin-bottom: 0"></label>
                            <input type="radio" class="hidden" name="carrier" id="ktt">
                            <label class="col-half logo-kt" for="ktt" style="margin-bottom: 0"></label>
                        </div>
                        <div class="row clearfix">
                    ...
                    <p class='savet-title' style="margin-bottom: 0;">알뜰폰이란?</p>
                    <p class="savet-txt">이동통신사(SKT, KT, LGU+)의 통신망을 임대하여 별도의<br>
                        휴대폰 서비스(MVNO)를 제공하는 사업자를 말합니다.</p>
                    
                    <div class="checkboxes-wrapper row" style="padding-bottom: 0">
            ...
            <div class='authent move-to-right'>
