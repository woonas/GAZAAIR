                           ...
                           <div id="mask">
                               <ul>
                                   ...
                                   <li id="second" class="secondanimation">
                                       <a href="#">
                                           <img src="../../IMG/login/seaofstar.jpg"/>
                                       </a>
                                       <div class="tooltip">
                                           <h1>별의 바다, 몰디브</h1>
                                       </div>
                                   ...
                                   <li id="fourth" class="fourthanimation">
                                       <a href="#">
                                           <img src="../../IMG/login/new-zealand-south-island.jpg"/>
                                       </a>
                                       <div class="tooltip">
                                           <h1>남섬, 뉴질랜드</h1>
                                       </div>
                                   ...
                                   <li id="fifth" class="fifthanimation">
                                       <a href="#">
                                           <img src="../../IMG/login/goldenTemple.jpg"/>
                                       </a>
                                       <div class="tooltip">
                                           <h1>황금사원, 인디아</h1>
                                       </div>
