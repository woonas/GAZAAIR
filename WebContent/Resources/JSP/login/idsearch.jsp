    ...
    <head>
        ...
        <script>
        	$(function(){
    			...
    			for(j=1; j<=12; j++){
    				if(j<=9){
    					monthTag += "<option value='0"+j+"'>0"+j+"</option>";
    				}else if(j>9){
    					monthTag += "<option value='"+j+"'>"+j+"</option>";
    				}
    			}
    			...
    			for(k=1; k<=31; k++){
    				if(k<=9){
    					dayTag += "<option value='0"+k+"'>0"+k+"</option>";
    				}else{
    					dayTag += "<option value='"+k+"'>"+k+"</option>";
    				}
    			}
    			$("#day").append(dayTag);
        		...
        		$("#idFind").click(function(){
            		...
            		$.ajax({
            			url : "<%=request.getContextPath() %>/Resources/JSP/login/idsearchOk.do",
            			data : params,
