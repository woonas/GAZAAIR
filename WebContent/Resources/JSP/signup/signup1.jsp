            ...
            <ul class="clearfix">
                <li class="li-korea">
                    <div>
                        ...
                        <a href="<%=path %>/Resources/JSP/signup/signup2.do"><button type="button" class="blueBtn" title="한국국적, 대한민국 거주자" id="btn-korea">선택하기</button></a>
                    </div>
                </li>
                <li class="li-foreign">
                    <div>
                        ...
                        <a href="<%=path %>/Resources/JSP/signup/signup2.do"><button type="button" class="blueBtn" title="해외 국적, 해외국적 한국인" id="btn-foreign">선택하기</button> </a>
                    </div>
                </li>
            </ul>
        </div>
