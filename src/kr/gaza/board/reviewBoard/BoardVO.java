 ...
 * regDate; private String ip; //����¡/////////////////////////// private int
 * pageNum=1; // ���������� private int onePageRecord=5;// ���������� ����� ���ڵ� �� private
 * int totalPage;//�� �������� private int totalRecord;//�� ���ڵ�� private int
 * startPage;//������ �ѹ� ���۰� private int onePageMax=5;//�ѹ��� ����� ������ ��ȣ ��
 * 
 * 
 * 
