 ...
 * }
 * 
 * }catch(Exception e) { System.out.println("레코드 전체 선택"); e.printStackTrace();
 ...
 * 
 * 
 * }catch(Exception e) { System.out.println("수정에러"); e.printStackTrace();
 * }finally { dbClose(); } return cnt; }
 * 
 ...
 * cnt = pstmt.executeUpdate();
 * 
 * }catch(Exception e) { System.out.println("삭제에러"); e.printStackTrace();
 * }finally { dbClose(); }
 * 
 * return cnt; }
 * 
 ...
 * 
 * int cnt = 0; //댓글 쓰기 try { dbConn(); //댓글 레코드 추가 String sql =
 ...
 * new ArrayList<ReplyVO>(); try { //댓글선택 String sql =
